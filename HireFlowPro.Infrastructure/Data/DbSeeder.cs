...
public static class DbSeeder
{
    ...
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        // ── 3b. Sample applications for the Super Admin (.NET Jobs India 2026) ──
        var adminApps = new List<Application>
        {
            // ── BANGALORE ──
            new() {
                UserId = admin.Id, JobTitle = ".NET Developer", Company = "Infosys",
                Location = "Bangalore", SalaryRange = "₹8–14 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.Medium,
                AppliedDate = now.AddDays(-12), FollowUpDate = now.AddDays(2),
                Notes = "Primary skill: .NET Core / C#; Agile methodology required.",
                Source = "Infosys Careers",
                CreatedAt = now.AddDays(-12), UpdatedAt = now.AddDays(-12),
                LastActivityDate = now.AddDays(-12),
            },
            new() {
                UserId = admin.Id, JobTitle = "Software Engineer (.NET)", Company = "Wipro",
                Location = "Bangalore", SalaryRange = "₹7–13 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.Medium,
                AppliedDate = now.AddDays(-10),
                Notes = "Hybrid 2–3 days WFO. Search 'dotnet' on portal.",
                Source = "Wipro Careers",
                CreatedAt = now.AddDays(-10), UpdatedAt = now.AddDays(-10),
                LastActivityDate = now.AddDays(-10),
            },
            new() {
                UserId = admin.Id, JobTitle = "Associate / Programmer Analyst (.NET)", Company = "Cognizant",
                Location = "Bangalore", SalaryRange = "₹7–12 LPA",
                Status = ApplicationStatus.Saved, Priority = ApplicationPriority.Low,
                Notes = "GenC / GenC Elevate tracks for experienced hires.",
                Source = "Cognizant Careers",
                CreatedAt = now.AddDays(-8), UpdatedAt = now.AddDays(-8),
                LastActivityDate = now.AddDays(-8),
            },
            new() {
                UserId = admin.Id, JobTitle = "Software Engineer – Microsoft Stack", Company = "HCL Technologies",
                Location = "Bangalore", SalaryRange = "₹8–15 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.Medium,
                AppliedDate = now.AddDays(-7), FollowUpDate = now.AddDays(7),
                Notes = "C#, ASP.NET Core, SQL Server; ERP projects available.",
                Source = "HCLTech Careers",
                CreatedAt = now.AddDays(-7), UpdatedAt = now.AddDays(-7),
                LastActivityDate = now.AddDays(-7),
            },
            new() {
                UserId = admin.Id, JobTitle = ".NET Backend Developer", Company = "Capgemini",
                Location = "Bangalore", SalaryRange = "₹8–14 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.Medium,
                AppliedDate = now.AddDays(-9),
                Notes = "Microsoft Dynamics / enterprise stack projects.",
                Source = "Capgemini Careers",
                CreatedAt = now.AddDays(-9), UpdatedAt = now.AddDays(-9),
                LastActivityDate = now.AddDays(-9),
            },
            new() {
                UserId = admin.Id, JobTitle = "ASP.NET Core Developer", Company = "Accenture",
                Location = "Bangalore", SalaryRange = "₹9–16 LPA",
                Status = ApplicationStatus.Interview, Priority = ApplicationPriority.High,
                AppliedDate = now.AddDays(-15), InterviewDate = now.AddDays(5),
                Notes = "Azure + .NET roles; BFS & public service verticals.",
                Source = "Accenture Careers",
                CreatedAt = now.AddDays(-15), UpdatedAt = now.AddDays(-3),
                LastActivityDate = now.AddDays(-3),
            },
            new() {
                UserId = admin.Id, JobTitle = "Backend Developer – .NET / C++", Company = "SAP India",
                Location = "Bangalore", SalaryRange = "₹14–22 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.High,
                AppliedDate = now.AddDays(-6), FollowUpDate = now.AddDays(8),
                Notes = "R&D centre Bangalore; ERP domain experience a plus.",
                Source = "SAP Careers",
                CreatedAt = now.AddDays(-6), UpdatedAt = now.AddDays(-6),
                LastActivityDate = now.AddDays(-6),
            },
            new() {
                UserId = admin.Id, JobTitle = "Software Engineer – C# / .NET", Company = "Microsoft India",
                Location = "Bangalore", SalaryRange = "₹20–30 LPA",
                Status = ApplicationStatus.Interview, Priority = ApplicationPriority.High,
                AppliedDate = now.AddDays(-20), InterviewDate = now.AddDays(2),
                Notes = "Azure / .NET platform teams; strong comp package.",
                Source = "Microsoft Careers",
                CreatedAt = now.AddDays(-20), UpdatedAt = now.AddDays(-2),
                LastActivityDate = now.AddDays(-2),
            },
            new() {
                UserId = admin.Id, JobTitle = ".NET Developer", Company = "Aiinhome Technologies",
                Location = "Bangalore", SalaryRange = "₹5–9 LPA",
                Status = ApplicationStatus.Saved, Priority = ApplicationPriority.Low,
                Notes = "Actively hiring; Bangalore City location.",
                Source = "SimplyHired",
                CreatedAt = now.AddDays(-4), UpdatedAt = now.AddDays(-4),
                LastActivityDate = now.AddDays(-4),
            },
            new() {
                UserId = admin.Id, JobTitle = ".NET Developer", Company = "Anvaya Info Solutions",
                Location = "Bangalore (Whitefield)", SalaryRange = "₹4–8 LPA",
                Status = ApplicationStatus.Saved, Priority = ApplicationPriority.Low,
                Notes = "Whitefield / Bangalore City; immediate joiners.",
                Source = "SimplyHired",
                CreatedAt = now.AddDays(-3), UpdatedAt = now.AddDays(-3),
                LastActivityDate = now.AddDays(-3),
            },
            new() {
                UserId = admin.Id, JobTitle = "ASP.NET Core Developer", Company = "Shifttocloud Software",
                Location = "Bangalore (Virgo Nagar)", SalaryRange = "₹6–10 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.Medium,
                AppliedDate = now.AddDays(-5),
                Notes = "Cloud-focused stack.",
                Source = "SimplyHired",
                CreatedAt = now.AddDays(-5), UpdatedAt = now.AddDays(-5),
                LastActivityDate = now.AddDays(-5),
            },
            ...
            // ── CHENNAI ──
            new() {
                UserId = admin.Id, JobTitle = "Software Engineer – .NET ERP", Company = "Ramco Systems",
                Location = "Chennai", SalaryRange = "₹8–16 LPA",
                Status = ApplicationStatus.Interview, Priority = ApplicationPriority.High,
                AppliedDate = now.AddDays(-18), InterviewDate = now.AddDays(4),
                Notes = "HRMS / Finance / ERP – ideal match for your profile.",
                Source = "Ramco Careers",
                CreatedAt = now.AddDays(-18), UpdatedAt = now.AddDays(-2),
                LastActivityDate = now.AddDays(-2),
            },
            new() {
                UserId = admin.Id, JobTitle = "Backend Developer – C# / .NET", Company = "Zoho Corporation",
                Location = "Chennai", SalaryRange = "₹10–18 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.High,
                AppliedDate = now.AddDays(-11), FollowUpDate = now.AddDays(3),
                Notes = "Product company HQ; strong engineering culture.",
                Source = "Zoho Careers",
                CreatedAt = now.AddDays(-11), UpdatedAt = now.AddDays(-11),
                LastActivityDate = now.AddDays(-11),
            },
            new() {
                UserId = admin.Id, JobTitle = ".NET Developer", Company = "TCS",
                Location = "Chennai (OMR)", SalaryRange = "₹7–13 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.Medium,
                AppliedDate = now.AddDays(-8),
                Notes = "OMR campus; large Microsoft practice.",
                Source = "TCS iBegin / NextStep",
                CreatedAt = now.AddDays(-8), UpdatedAt = now.AddDays(-8),
                LastActivityDate = now.AddDays(-8),
            },
            new() {
                UserId = admin.Id, JobTitle = "Backend Engineer", Company = "Freshworks",
                Location = "Chennai", SalaryRange = "₹14–22 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.High,
                AppliedDate = now.AddDays(-13),
                Notes = "SaaS company; strong growth track; Java/Go primary but .NET roles exist.",
                Source = "Freshworks Careers",
                CreatedAt = now.AddDays(-13), UpdatedAt = now.AddDays(-13),
                LastActivityDate = now.AddDays(-13),
            },
            new() {
                UserId = admin.Id, JobTitle = ".NET Developer – Microsoft Dynamics", Company = "HCL Technologies",
                Location = "Chennai (OMR)", SalaryRange = "₹8–14 LPA",
                Status = ApplicationStatus.Saved, Priority = ApplicationPriority.Medium,
                Notes = "OMR campus; ERP / Microsoft stack.",
                Source = "HCLTech Careers",
                CreatedAt = now.AddDays(-6), UpdatedAt = now.AddDays(-6),
                LastActivityDate = now.AddDays(-6),
            },
            new() {
                UserId = admin.Id, JobTitle = "Programmer Analyst – .NET", Company = "Cognizant",
                Location = "Chennai / Coimbatore", SalaryRange = "₹7–12 LPA",
                Status = ApplicationStatus.Saved, Priority = ApplicationPriority.Low,
                Notes = "Coimbatore & Chennai offices; GenC experienced track.",
                Source = "Cognizant Careers",
                CreatedAt = now.AddDays(-5), UpdatedAt = now.AddDays(-5),
                LastActivityDate = now.AddDays(-5),
            },
            new() {
                UserId = admin.Id, JobTitle = "Software Engineer – .NET", Company = "LTIMindtree",
                Location = "Chennai", SalaryRange = "₹8–14 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.Medium,
                AppliedDate = now.AddDays(-9),
                Notes = "Chennai campus; enterprise application projects.",
            ...
            // ── COIMBATORE ──
            new() {
                UserId = admin.Id, JobTitle = ".NET Developer", Company = "KGISL Technologies",
                Location = "Coimbatore", SalaryRange = "₹5–10 LPA",
                Status = ApplicationStatus.Offer, Priority = ApplicationPriority.High,
                AppliedDate = now.AddDays(-25),
                Notes = "Largest IT employer in Coimbatore; enterprise projects. Offer received!",
                Source = "KGISL Careers",
                CreatedAt = now.AddDays(-25), UpdatedAt = now.AddDays(-1),
                LastActivityDate = now.AddDays(-1),
            },
            new() {
                UserId = admin.Id, JobTitle = "Analyst / Associate – .NET", Company = "Cognizant (CBE Office)",
                Location = "Coimbatore", SalaryRange = "₹6–11 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.Medium,
                AppliedDate = now.AddDays(-7),
                Notes = "Coimbatore campus actively hiring.",
                Source = "Cognizant Careers",
                CreatedAt = now.AddDays(-7), UpdatedAt = now.AddDays(-7),
                LastActivityDate = now.AddDays(-7),
            },
            new() {
                UserId = admin.Id, JobTitle = "ERP Developer – .NET", Company = "RoadmapIT",
                Location = "Coimbatore", SalaryRange = "₹4–8 LPA",
                Status = ApplicationStatus.Interview, Priority = ApplicationPriority.High,
                AppliedDate = now.AddDays(-14), InterviewDate = now.AddDays(1),
                Notes = "HRMS / Inventory ERP; your background is direct match.",
                Source = "RoadmapIT Website",
                CreatedAt = now.AddDays(-14), UpdatedAt = now.AddDays(-3),
                LastActivityDate = now.AddDays(-3),
            },
            new() {
                UserId = admin.Id, JobTitle = "ASP.NET Core Developer", Company = "Codezeros",
                Location = "Coimbatore", SalaryRange = "₹5–9 LPA",
                Status = ApplicationStatus.Applied, Priority = ApplicationPriority.Medium,
                AppliedDate = now.AddDays(-4),
                Notes = "Product company; API + backend focus.",
                Source = "Codezeros Careers",
                CreatedAt = now.AddDays(-4), UpdatedAt = now.AddDays(-4),
                LastActivityDate = now.AddDays(-4),
            },
        };

        db.Applications.AddRange(adminApps);
        await db.SaveChangesAsync();
